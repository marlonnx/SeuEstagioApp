...
/*   fire: {
    apiKey: "AIzaSyBBAmWGPeACRE73HrhBjQF8lGkRa9IhH70",
    authDomain: "seu-estagio-app.firebaseapp.com",
    databaseURL: "https://seu-estagio-app.firebaseio.com",
    projectId: "seu-estagio-app",
    storageBucket: "seu-estagio-app.appspot.com",
